...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-900 to-neutral-700 text-white py-10 px-5">
      <div className="max-w-4xl mx-auto bg-neutral-800 shadow-2xl rounded-lg overflow-hidden p-8">
